...
@section('content')
    <div class="card mt-4">
        <div class="card-header">
            <a href="/student/formadd" class="btn btn-primary" role="button"><i class="bi bi-plus-square-fill"> Student</i></a>
                        ...
                        @foreach ($mhs as $idx => $m)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/student/delete/{{ $m->id }}" class="btn btn-danger"><i class="bi bi-x-square"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                  </table>
                  {{-- harus menggunakan nama key nya --}}
